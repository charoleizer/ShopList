...
public class MapaActivity extends FragmentActivity implements LocationListener {
    ...
    private void setUpMap() {
        ...
        if (l != null) {
            mMap.addMarker(new MarkerOptions().position(new LatLng(l.getLatitude(), l.getLongitude())).title("Marker"));
        ...
        CameraUpdate centro = null;
        if (l != null) {
            centro = CameraUpdateFactory.newLatLng(new LatLng(l.getLatitude(), l.getLongitude()));
        } else {
    ...
    public void onLocationChanged(Location location) {
        Log.i("SHOPLIST", location.getLatitude() + " - " + location.getLongitude());
    }
